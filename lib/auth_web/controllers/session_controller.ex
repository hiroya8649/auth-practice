defmodule AuthWeb.SessionController do
  ...
  alias Auth.Sessions
  alias AuthWeb.Auth.Login
  alias AuthWeb.Auth.Token
  ...
  def create(conn, %{"session" => params}) do
    case Login.verify(params) do
      {:ok, user} ->
        ...
        # database, remove this line, the Auth.Sessions alias and the
        # Auth.Sessions and Auth.Sessions.Session modules
